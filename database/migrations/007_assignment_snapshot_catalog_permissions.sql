-- Catalogue reads use MVCC. A row lock would require UPDATE permission from the
-- restricted runtime role and is unnecessary because measurement fields are immutable.
