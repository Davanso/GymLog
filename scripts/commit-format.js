...
function parseHeader(header) {
  const match = /^(?<type>[a-z][a-z0-9]*)(?:\((?<scope>[a-z0-9][a-z0-9._/-]*)\))?(?<breaking>!)?:\s+(?<subject>.*)$/.exec(header)
...
export function validateHeader(header = '') {
  ...
  return [valid, 'Use tipo(escopo opcional): emoji descrição, com o emoji da tabela, até 100 caracteres e sem ponto final. Ex.: feat: ✨ adicionar treino']
}
